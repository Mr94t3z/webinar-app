...
class Seminar extends CI_Controller
{
   ...
   if (!$this->ion_auth->logged_in()) {
    ...
    public function add()
    {
         ...
         * @return	void
         */
        $llink_meet = form_label('Link Meet', 'link_meet');
        /**
         * $ltgl_pelaksana.
         *
         * @param	string	'Tanggal Pelaksaan'	
        ...
        /**
         * @var		mixed	$attr_linkmeet
         */
        $attr_linkmeet = array(
            'type' => 'text',
            'name' => 'link_meeting',
            'id' => 'link_meeting',
            'value' => set_value('link_meeting'),
         ...
         * $i_linkmeet.
         *
         * @param	mixed	$attr_linkmeet
         * @return	void
         */
        $i_linkmeet = form_input($attr_linkmeet);
        /**
         * $i_tglpelaksanaan.
         *
         ...
         * @return	void
         */
        $fe_linkmeet = form_error('link_meet');
        /**
         * $fe_linkmeet.
         *
         * @param	string	'link_meet'	
         * @return	void
         */
    ...
    public function addaction()
    {
        ...
        if ($validasi ==  FALSE) {
            ...
            if (!$this->upload->do_upload('lampiran')) {
                ...
                /**
                 * @var		mixed	$this->input->post('link_meet'
                 */ /**
                 * @var		mixed	TRUE)
                 */
    ...
    public function update($id)
    {
        ...
        if ($get_row->num_rows() > 0) {
             ...
             * Label
             *
             * @param	string	'Link Meet'	
             * @param	string	'link_meet'	
             * @return	void
             */
            $llink_meet = form_label('Link Meet', 'link_meeting');
            /**
             * $ltgl_pelaksana.
             *
             * @param	string	'Tanggal Pelaksaan'	
            ...
            $attr_linkmeet = array(
                ...
                'name' => 'link_meeting',
                'id' => 'link_meeting',
                'value' => set_value('link_meeting', $link_meet),
                'placeholder' => 'Link Meet',
                'class' => 'form-control'
            );
            /**
    ...
    public function editaction()
    {
        ...
        $nama_seminar = $this->input->post('nama_seminar', TRUE);
         /**
         * @var		mixed	$this->input->post('link_meeting')
         */
        $link_meet = $this->input->post('link_meeting', TRUE);
        /**
         * @var		mixed	$this->input->post('tanggal_pelaksanaan')
         */
    ...
    public function _rules()
    {
         ...
         */
        $attr_linkmeet = array(
            'required' => 'Link meet harus di isi!',
        );
        /**
        ...
        $this->form_validation->set_rules('link_meeting', 'Link Meet', 'trim|required', $attr_linkmeet);
