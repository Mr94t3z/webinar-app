                ...
                <div class="row align-items-center">
                    <div class="col-md-6 mb-5">
                        <div class="card-body">
                            ...
                            <img src="<?php echo base_url() ?>assets/backend/template/assets/images/front_logo.jpg" alt="" class="img-fluid mb-4">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                        ...
                                        <p class="mb-5">Sistem pendaftaran peserta webinar (seminar) menggunakan QR Code</p>
                                    </div>
                                </div>
