                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="chat-header">Link Meet</div>
                                        <p class="chat-header text-muted"><a href="<?= $link_meet ?>"><?= $link_meet ?></a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
            ...
            <div class="card user-card user-card-2 shape-center card-pembicara">
                <div class="card-header border-0 p-2 pb-0">
                    <div class="cover-img-block">
                        <img src="<?php echo base_url() ?>assets/images/widget/back.jpg" alt="" class="img-fluid">
                    </div>
                </div>
